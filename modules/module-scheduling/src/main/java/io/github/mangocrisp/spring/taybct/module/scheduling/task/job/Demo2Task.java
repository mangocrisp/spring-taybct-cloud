package io.github.mangocrisp.spring.taybct.module.scheduling.task.job;
...
@Slf4j
@Scheduler("demo2")
public class Demo2Task extends AbstractScheduledTaskJob {
    ...
    public void run(Map<String, Object> params) throws Exception {
        log.info("demo2 task => 当前线程名称 {} ", Thread.currentThread().getName());
